...
![Java常用的线程安全的内置队列](/source/images/diruptor/disruptor-queues.png)
...
### 2.2.1 锁
![锁](/source/images/diruptor/锁.png)
...
![通过原子变量CAS实现线程安全](/source/images/diruptor/通过原子变量CAS实现线程安全.png)
...
![计算机CPU与缓存示意图](/source/images/diruptor/计算机CPU与缓存示意图.png)
当CPU执行运算的时候，它先去L1查找所需的数据、再去L2、然后是L3，如果最后这些缓存中都没有，所需的数据就要去主内存拿。走得越远，运算耗费的时间就越长。所以如果你在做一些很频繁的事，你要尽量确保数据在L1缓存中。

另外，线程之间共享一份数据的时候，需要一个线程把数据写回主存，而另一个线程访问主存中相应的数据。

下面是从CPU访问不同层级数据的时间概念:
![CPU访问](/source/images/diruptor/CPU访问.png)
...
![伪共享示意图](/source/images/diruptor/伪共享示意图.png)
...
若是返回的正确，则生产者开始写入元素。
![单生产者生产过程](/source/images/diruptor/单生产者生产过程.png)
## 3.2.多个生产者
...
![多生产下的消费者](/source/images/diruptor/多生产下的消费者.png)
### 3.2.2.写数据
多个生产者写入的时候：
...
![多生产下的生产者](/source/images/diruptor/多生产下的生产者.png)
...
```
## 4.2.消费者的等待策略
![消费者的等待策略](/source/images/diruptor/消费者的等待策略.png)